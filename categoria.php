...
<div id="cont_categoria"  class="col s12 m12 l12">
  ...
  <div id="cont_categoria_head" class="col s12 m12 l12">
    <h1 class="center">Belleza</h1>
    <div class="cont_categoria_head_navBar_subCategorias">
       <ul class="col s12 m12 l12">
         <li><a class="waves-effect btn">#Peinados</a></li>
         <li><a class="waves-effect btn">#Uñas</a></li>
         <li><a class="waves-effect btn">#MakeUp</a></li>
         <li><a class="waves-effect btn">#Look</a></li>
         <li><a class="waves-effect btn">#Moda</a></li>
         <li><a class="waves-effect btn">#Fitness</a></li>
         <li><a class="waves-effect btn">#Accesorios</a></li>
       </ul>
    </div>
  </div>
  ...
  <div id="cont_categoria_section"  class="col s12 m12 l12">
    ...
    <div class="cont_categoria_section_result col s12 m12 l8">
          ...
          <div class="cont_categoria_section_result_post">
                  ...
                  <a href="" alt="" target="_self">
                        <div class="result_post_01 col s12 m6 s6">
                            <div class="result_post_01_contenido">
                                  <div class="result_post_01_contCat">
                                      <div class="result_post_01_contCat_bot">Belleza</div>
                                      <div class="result_post_01_contCat_subcat">#uñas</div>
                                  </div>
                                  <h1>Titulo uno muy interesante sobre el contenido</h1>
                        ...
                        <div class="result_post_02 col s12 m6 s6">
                            <img src="img/post/post_01.jpg" alt=""/>
          ...
          <div class="cont_categoria_section_result_post">
                  ...
                  <a href="#!" alt="" target="_self">
                        <div class="result_post_02 col s12 m6 s6">
                            <img src="img/post/post_02.jpg" alt=""/>
                            <div class="result_post_02_contOpacity"></div>
                        </div>
                  ...
                  <a href="#!" alt="" target="_self">
                        ...
                        <div class="result_post_01 col s12 m6 s6">
                          <div class="result_post_01_contenido">
                                <div class="result_post_01_contCat">
                                    <div class="result_post_01_contCat_bot">Belleza</div>
                                    <div class="result_post_01_contCat_subcat"><a href="" alt="">#uñas</a></div>
                                </div>
                                <h1>Titulo uno muy interesante sobre el contenido</h1>
                                <p>Aprendé sobre moda, look, uñas, tendencias, makeup con las mejores de toda habla hispana.</p>
                                <div class="result_post_01_contenido_icon"></div>
